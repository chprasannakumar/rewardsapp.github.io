...
import { FILTER_DEFAULTS, MONTH_FILTER_OPTIONS } from '../constants';
          ...
          <>
            ...
            >
              ...
              <Autocomplete
                ...
                onChange={(e, newValue) => updateFilters('userId', newValue ? newValue.customerId : 'all')}
                renderInput={(params) => (
                  <TextField
                    {...params}
                    label="All Customers"
            ...
            <Grid container spacing={5}>
              ...
              <Grid container item xs={12} spacing={5}>
                <Grid item xs={12} lg={4}>
                  <TotalRewardsTable rewards={filteredData.total} isLoading={isUpdating} />
                </Grid>
                <Grid item xs={12} lg={8}>
                  <MonthlyRewardsTable rewards={filteredData.monthly} isLoading={isUpdating} />
                </Grid>
              </Grid>
            </Grid>
          </>
